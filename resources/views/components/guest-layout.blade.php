...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-surface text-text-primary font-sans antialiased min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        <div class="w-full sm:max-w-md px-6">
            ...
            <div class="bg-surface-card border border-border-hairline sm:rounded-xl p-8">
                {{ $slot }}
            </div>
        </div>
    </body>
